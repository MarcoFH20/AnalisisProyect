// ReportesEntradas.jsx replicado con mejoras del componente de juegos
...
function ReportesEntradas() {
  ...
  const filtrar = () => {
    return reportes.filter((r) => {
      ...
      return esModulo && esTipo && esEstado && esTipoEntrada && enRango;
    });
  };
      ...
      <table className="usuarios-tabla">
        ...
        <tbody>
          {paginaActual.length === 0 ? (
            <tr>
              <td colSpan="9" style={{ textAlign: "center" }}>No hay reportes</td>
            </tr>
          ) : (
            paginaActual.map((r) => (
              <tr key={r.id}>
                ...
                <td>
                  <button onClick={() => abrirModal(r)} style={{ padding: "4px 8px", background: "#3b82f6", color: 'white', border: 'none', borderRadius: '4px' }}>
                    Ver
                  </button>
                </td>
              </tr>
      ...
      >
        ...
        {detalleSeleccionado && (
          <ul style={{ listStyle: 'none', padding: 0, lineHeight: '1.6rem' }}>
            ...
            <li><strong>🔒 Estado:</strong> {detalleSeleccionado.estado}</li>
            <li><strong>🔢 Serie:</strong> {detalleSeleccionado.serie}</li>
            <li><strong>🎫 Tipo Entrada:</strong> {detalleSeleccionado.tipoEntrada}</li>
            <li><strong>📅 Fecha Emisión:</strong> {detalleSeleccionado.fecha_emision || '-'}</li>
            <li><strong>✅ Fecha Validación:</strong> {detalleSeleccionado.fecha_validacion || '-'}</li>
